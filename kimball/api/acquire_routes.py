...
metadata_source_manager = MetadataSourceManager()  # New metadata.acquire-based (used for connection testing)
...
# Data Source Management endpoints moved to Administration API group
# Use /api/v1/admin/datasources for CRUD operations
